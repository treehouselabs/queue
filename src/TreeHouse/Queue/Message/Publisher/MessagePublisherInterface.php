...
interface MessagePublisherInterface
{
     ...
     * @param int   $priority Priority for the message, this must be a number between 0 (lowest) and 9 (highest)
     *
     * @return Message
     */
     ...
     * @param int       $flags   AMQP flags to publish the message with
     *
